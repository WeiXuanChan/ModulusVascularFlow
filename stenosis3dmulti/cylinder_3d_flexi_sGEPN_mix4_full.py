...
def run(cfg: ModulusConfig) -> None:
    ...
    caseIDlatent_net = CaseIDtoFeatureArch(
        input_key=Key("caseID"),
        output_keys=[Key("latent",size=4)],
        feature_array=feature_array,
    )
    #latentScale_module=CustomModuleArch(
    #    [Key("latent",size=16)],
    #    [Key("scaledlatent",size=4)],
    #    module=latentScale()
    #    )
    ...
    flow_net = FullyConnectedArch(
        input_keys=[Key("x_case"), Key("y_case"), Key("z_case"),Key("latent",size=4)],
    ...
    result_net = FullyConnectedFlexiLayerSizeArch(
            input_keys=[Key("x_case"), Key("y_case"), Key("z_case"),Key("cline"),Key("radius_y"),Key("radius_z"),Key("vec_x"),Key("vec_y"),Key("vec_z"),Key("dissq"),Key("arearatio")]+incrorderVar+[Key("latent",size=4)],
