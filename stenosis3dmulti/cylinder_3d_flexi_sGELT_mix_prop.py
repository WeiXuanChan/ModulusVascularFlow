...
def run(cfg: ModulusConfig) -> None:
    ...
    channel_checkpoint_nd=tuple(map(lambda x: nd.ndim(quantity(x, "m")), np.linspace(-0.15,0.15,5)[1:-1]))
    channel = tubeWall(
        channel_center_nd,
    ...
    result_net=CustomModuleArch(
        ...
        module=PROPcombine(19,4,[512,512,512,512,512,512],channel_checkpoint_nd,nd.ndim(quantity(0.005, "m"))),
    )
