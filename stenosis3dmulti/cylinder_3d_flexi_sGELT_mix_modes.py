...
def run(cfg: ModulusConfig) -> None:
    ...
    if not(os.path.isfile("/examples/stenosis3dmulti/outputs/"+sys.argv[0][:-3]+"/flow_network.0.pth")):
        ...
        shutil.copy("/examples/stenosis3dmulti/outputs/"+sys.argv[0][:-9]+"/flow_network.0.pth","/examples/stenosis3dmulti/outputs/"+sys.argv[0][:-3]+"/flow_network.0.pth")
    ...
    result_net = FullyConnectedFlexiLayerSizeArch(
        ...
        layer_sizeList=[1600,total_modes,total_modes,total_modes,total_modes],#20096256 trainables
    ...
    modeweights_net = HypernetFullyConnectedFlexiLayerSizeArch(
        ...
        layer_sizeList=[512,512,512,32],#814112 trainables
