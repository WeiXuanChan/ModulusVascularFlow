...
def run(cfg: ModulusConfig) -> None:
    ...
    if not(os.path.isfile("/examples/stenosis3dmulti/boundary_pts"+addstr+".npy")):
        ...
        np.save("/examples/stenosis3dmulti/boundary_pts"+addstr+".npy",caseBoundarypt)
        return 0
    else:
        caseBoundarypt=np.load("/examples/stenosis3dmulti/boundary_pts"+addstr+".npy")
    total_modes=1024
