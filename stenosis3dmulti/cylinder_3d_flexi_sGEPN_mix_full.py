...
def run(cfg: ModulusConfig) -> None:
    ...
    feature_array=np.load("/examples/stenosis3dmulti/outputs/cylinder_3d_flexi_sGEPN_mix/inferencers/eval_latent_all.npy")
    ...
    result_net = FullyConnectedFlexiLayerSizeArch(
            input_keys=[Key("x_case"), Key("y_case"), Key("z_case"),Key("cline"),Key("radius_y"),Key("radius_z"),Key("vec_x"),Key("vec_y"),Key("vec_z"),Key("dissq"),Key("arearatio")]+incrorderVar+[Key("scaledlatent",size=16)],
