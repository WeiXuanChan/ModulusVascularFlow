...
def run(cfg: ModulusConfig) -> None:
    ...
    radii_net = FullyConnectedFlexiLayerSizeArch(
            ...
            output_keys=[Key("prenormmodes",size=int(total_modes/2.)),Key("preothermodes",size=int(total_modes/2.)),Key("pmodes",size=256)],
    ...
    cline_net = FullyConnectedFlexiLayerSizeArch(
            input_keys=[Key("cline"),Key("arearatio")],
            output_keys=[Key("normweights",size=int(total_modes/2.)),Key("other1weights",size=total_modes),Key("other2weights",size=total_modes),Key("dpweights",size=256),Key("dpbias")],
            layer_sizeList=[1024,512],
        )
    sethb_net = MultiplicationArch(
        input1_keys=[Key("prenormmodes",size=int(total_modes/2.)),Key("preothermodes",size=int(total_modes/2.))],
        input2_keys=[Key("hb")],
    ...
    get_p_net = SumMultiplicationArch(
        input1_keys=[Key("pmodes",size=256)],
        input2_keys=[Key("dpweights",size=256)],
        output_keys=[ Key("dp_w")],
    )
    pbias_module=AdditionArch(
        input1_keys=[Key("dp_w")],
        input2_keys=[Key("dpbias")],
        output_keys=[Key("dp")],
        )
