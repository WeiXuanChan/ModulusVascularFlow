...
def run(cfg: ModulusConfig) -> None:
    ...
    if not(os.path.isfile("/examples/stenosis3d/outputs/"+sys.argv[0][:-3]+"/flow_network.0.pth")):
        ...
        shutil.copy("/examples/stenosis3d/outputs/"+sys.argv[0][:-18]+"/flow_network.0.pth","/examples/stenosis3d/outputs/"+sys.argv[0][:-3]+"/flow_network.0.pth")
    # physical quantities
    ...
    #print("set integral to",0.5*nd.ndim(inlet_u)*int(cfg.batch_size.inlet)
